...
<div class="row" >
    ...
    <div class="col-md-10" >
        ...
        <div class="row col-md-2" style="margin: 20px">
            <button type="button" class="btn btn btn-outline-dark" title="Crear un rol" onclick="openModal();"><i class="fas fa-plus"></i> Añadir un proveedor</button>
        </div>
        <section>
           <div class="table-responsive" style="margin: 20px;height:650px;background-color: whitesmoke;box-shadow: 3px 3px lightgray;">
               <table class="table table-hover table-bordered" id="table-supplier"></table>
           </div>
        </section>
    </div>
</div>
...
<script  src="http://localhost/tfg/constructalia/Assets/js/functions_supplier.js"></script>