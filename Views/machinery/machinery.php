...
<header style="background-color: #1C2833;height: 50px;color: white" class="text-right">
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" aria-expanded="false">
...
<div class="row" >
    ...
    <div class="col-md-10">
        ...
        <div class="row col-md-2" style="margin: 20px">
            <button type="button" class="btn btn-warning" title="Añadir maquina" onclick="openModal();"><i class="fas fa-plus"></i>Añadir una maquina</button>
        </div>
        <section>
...
<script  src="http://localhost/tfg/constructalia/Assets/js/functions_machinery.js"></script>