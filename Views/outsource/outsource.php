<?php getModal('modalOutsource',$data); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="row" >
    ...
    <div class="col-md-10">
        ...
        <div class="row col-md-2" style="margin: 20px">
            <button type="button" class="btn btn-warning" title="Añadir una subcontrata" onclick="openModal();"><i class="fas fa-plus"></i>Añadir una subcontrata</button>
        </div>
        <section>
            <div class="table-responsive" style="margin: 20px;background-color: whitesmoke;box-shadow: 3px 3px lightgray;">
                <table class="table table-hover table-bordered" id="table-outsource"></table>
            </div>
        </section>
    </div>
</div>
...
<script  src="http://localhost/tfg/constructalia/Assets/js/functions_outsource.js"></script>