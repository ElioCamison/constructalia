...
ALTER TABLE PERMISSION ADD description VARCHAR(100) NULL AFTER name;
ALTER TABLE PERMISSION ADD is_active BOOLEAN NOT NULL AFTER description;
...
ALTER TABLE ROL ADD description VARCHAR(100) NULL AFTER name;
ALTER TABLE ROL ADD is_active BOOLEAN NOT NULL AFTER description;
